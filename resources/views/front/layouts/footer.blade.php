<div> 
 <footer class="bg-white">
        <div class="mx-auto max-w-screen-l px-4 py-16 sm:px-6 lg:px-8">
            <div
                class="flex flex-col items-center gap-4 rounded-lg bg-teal-700 p-6 shadow-lg sm:flex-row sm:justify-between">
                <strong class="text-xl text-white sm:text-xl">
                    Fill Your Cart Now!
                </strong>

                <a class="inline-flex items-center gap-2 rounded-full border border-white bg-white px-8 py-3 text-teal-700 hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
                    href="product.html">
            ...
            <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                <div class="text-left sm:text-left">
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            <div class="text-gray-700 transition hover:text-gray-700/75" style="cursor: pointer" href="#"id="noRefreshLink">
                                Company History
                            </div>
                        </li>
                ...
                <div class="text-left sm:text-left">
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        ...
                        <li>
                            <div style="cursor: pointer" href="#"id="noRefreshLink" class="group flex justify-start gap-1.5 ltr:sm:justify-start rtl:sm:justify-end"
                                href="#"  id="noRefreshLink">
            ...
            <div class="mt-16">
                <ul class="flex justify-center gap-6 sm:justify-end">
                    <li>
                        <div style="cursor: pointer" href="#"id="noRefreshLink" rel="noreferrer" target="_blank"
