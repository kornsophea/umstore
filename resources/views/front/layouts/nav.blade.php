  <header class="bg-white-700 backdrop-blur sticky top-0 z-10 border-b">
        <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="md:flex md:items-center md:gap-12">
                    <a class="block text-teal-700" href="index.html">
                ...
                <div class="hidden md:block">
                    <nav>
                        <ul class="flex items-center gap-6">
                            <li>
                                <a class="transition font-bold hover:text-white" href="/">
                                    Home
                                </a>
                            </li>
         ...
         <ul class="hidden lg:flex flex-row space-x-4">
                <li>
                    @auth
